...
export HADOOP_NAMENODE_OPTS="${SHARED_HADOOP_NAMENODE_OPTS}  -Dorg.mortbay.jetty.Request.maxFormContentSize=-1 ${HADOOP_NAMENODE_OPTS}"
...
export HADOOP_SECURE_DN_USER=hduser
